...
<CardGroup cols={2}>
  <Card title="Mark as Read" icon="check" href="/api/memos/update">
    Mark the memo as read if you're a recipient
  </Card>
  <Card title="Approve Memo" icon="thumbs-up" href="/api/memos/update">
    Approve the memo if you're an authorized approver
  </Card>
  <Card title="Reject Memo" icon="thumbs-down" href="/api/memos/update">
